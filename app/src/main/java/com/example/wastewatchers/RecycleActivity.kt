...
class RecycleActivity : AppCompatActivity() {
    ...
    fun classifyImageWithHuggingFace(imageFile: File) {
        ...
        val token = "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"
    ...
    fun sendToOpenAI(prompt: String, onResult: (String) -> Unit) {
        ...
        val apiKey = "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"
        val requestBody = """
            {
                "model": "gpt-4o-mini",
                "max_tokens": 75,
